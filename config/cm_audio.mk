...
ALARM_PATH := vendor/vm12/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/vm12/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/vm12/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/vm12/prebuilt/common/media/audio/ui
